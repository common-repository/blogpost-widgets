...
?>
<div class="blogpost-author-box layout-<?php echo $layout ?><?php echo ($settings['default_shadow'] == 'yes' ? ' has-shadow' : '') ?>">
    ...
    <div class="cb-authorbox-right-col">
        ...
        <div class="cb-author-articles">
            ...
            <div class="cb-author-posts">
                <?php Helper::blogpost_author_recent_post($settings['author_id'],$settings['author_posts_limit']); ?>
            </div>
        </div>
        <?php endif; ?>
    </div>		
