 ...
 * @since 1.0.0
 */
class blogpost_Classic_Posts extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'blogpost-posts-classic', plugins_url( '/assets/css/posts-classic.css', BLOGPOST_WIDGETS ), array(), '1.0.0' );
	...
	public function get_title() {
		return __( 'Classic Posts', 'blogpost-widgets' );
	}
	...
	public function get_icon() {
		return 'blogpost-icon-posts-classic';
	}
	...
	public function get_style_depends() {
		return array( 'blogpost-posts-classic' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'blogpost_post_list_widget_head_typography',
                'label' => __('Typography', 'blogpost-widgets'),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' =>
					'{{WRAPPER}} .blogpost-widget-head h3',
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333333',
                'selectors' => [
                    '{{WRAPPER}} .blogpost-posts-classic .item-meta .post-title a' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#f6ce2b',
                'selectors' => [
                    '{{WRAPPER}} .blogpost-posts-classic .item-meta .post-title a:hover' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#555555',
                'selectors' => [
                    '{{WRAPPER}} .blogpost-posts-classic .list-item .list-meta-info' => 'color: {{VALUE}};',
					'{{WRAPPER}} .blogpost-posts-classic .list-item .list-meta-info a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .blogpost-posts-classic .list-item .list-meta-info i' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
					'{{WRAPPER}} .blogpost-posts-classic .item-meta' => 'text-align: {{VALUE}};',
					'{{WRAPPER}} .blogpost-posts-classic .item-meta .post-title' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'blogpost_post_list_title_large_typography',
                'label' => __('Post Title (Large Grid)', 'blogpost-widgets'),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' =>
					'{{WRAPPER}} .blogpost-posts-classic .item-1 .item-meta .post-title',
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                ...
                'label' => __('Post Title (Small Grids)', 'blogpost-widgets'),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' =>
					'{{WRAPPER}} .blogpost-posts-classic .item-meta .post-title',
            ]
        );
		$this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                ...
                'selector' => '{{WRAPPER}} .blogpost-posts-classic .item-meta .post-desc',
            ]
        );
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogpost-posts-classic .list-item .grid-post-term span.term-icon' => 'background-color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogpost-posts-classic .list-item .grid-post-term span.term-icon' => 'color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogpost-posts-classic .list-item .grid-post-term span.term-name' => 'background-color: {{VALUE}}',
				],
				'default' => '#f6ce2b',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogpost-posts-classic .list-item .grid-post-term span.term-name' => 'color: {{VALUE}}',
				],
				'default' => '#000000',
			]
		);
	...
	protected function render() {
		...
		?>
            <div class="blogpost-posts-classic-container">
                <?php
				...
				<?php } ?>
                <div class="blogpost-posts-classic layout-<?php echo esc_attr($layout) ?>">
                    <?php
                        ...
                        <div class="list-item<?php echo ( esc_attr($layout == 1 || $layout == 2 ? ' item-1' : '') ) ?>">
                                ...
                                <a href="<?php the_permalink() ?>">
                                    <?php
                                        if(has_post_thumbnail()):
                                            the_post_thumbnail('blogpost-classic-thumb-large');
                                        else:
                                            echo '<img src="'.BLOGPOST_ASSETS_PATH.'img/thumb-medium.png">';
                                        endif;
                                    ?>
                                </a>
                                <?php
                            ...
                            <div class="item-meta">
                                ...
                                if ( 'yes' === $settings['show_excerpt'] ) { ?>
                                    <p class="post-desc"><?php echo esc_attr ($layout == 1 || $layout == 2 ? Helper::blogpost_list_excerpt(25) : Helper::blogpost_list_excerpt(50)) ?></p>
                                <?php } ?>
                    ...
                    <?php else: ?>
                        <div class="list-item">
                            ...
                            <div class="item-meta">
                                ...
                                <?php
                                if ( 'yes' === $settings['show_excerpt'] ) { ?>
                                    <p class="post-desc"><?php echo esc_attr ( $layout == 1 || $layout == 2 ? Helper::blogpost_list_excerpt(15) : Helper::blogpost_list_excerpt(50) )?></p>
                                <?php } ?>
