 ...
 */
namespace blogpostWidgets\Classes;
...
class Helper
{
     ...
     * @return string
     */
    public static function blogpost_post_category() {
     ...
     * @return string
     */
    public static function blogpost_post_format_icon() {
     ...
     * @return string
     */
    public static function blogpost_post_term_box() {
        $format = get_post_format() ? : 'standard';
        $format_icon = "icon-folder";
        switch($format) {
            case "aside": 
     ...
     * @return array
     */
    public static function blogpost_get_post_types() {
     ...
     * @return array
     */
    public static function blogpost_get_categories() {
     ...
     * @return array
     */
    public static function blogpost_get_post_orderby_options() {
        $orderby = array(
            'ID' => 'Post ID',
            'author' => 'Post Author',
            'title' => 'Title',
     ...
     * @return array
     */
    public static function blogpost_get_query_args($settings = [], $post_type = 'post') {
     ...
     * @return string
     */
    public static function blogpost_small_grid_class($layout = 1, $index = 1) {
        if($layout == 1 && $index != 1) {
            echo " small-grid";
     ...
     * @return string
     */
    public static function blogpost_list_excerpt($count=20) {
     ...
     * @return string
     */
    public static function blogpost_posted_on() {
     ...
     * @return string
     */
    public static function blogpost_posted_by() {
		$byline = sprintf(
     ...
     * @return string
     */
    public static function blogpost_entry_comments() {
		...
		if($comment_count == 0) {
			...
			echo wp_kses('<span class="post-meta post-comments"><i class="icon-chat"></i> <a href="'.esc_url(get_comments_link( get_the_ID()) ).'">'. esc_html__(" 0", "blogpost-widgets") .'</a></span>', $tags);
     ...
     * @return string
     */
    public static function blogpost_hex2rgba($color, $opacity = false) {
     ...
     */
    public static function blogpost_author_recent_post($id,$limit) {
        $author_id = intval($id);
